...
const initialState = {
    standard_measurements_upperbody: [],
    loginUser: null,
    error: false,
    loading: false,
    message: null
...
const standard_measurements_upperbody_reducer = (state = initialState, action) => {
    switch (action.type) {

        case GET_USER_MEASUREMENTS_UPPERBODY_LIST_SUCCESS:
            return { ...state, standard_measurements_upperbody: action.standard_measurements_upperbody, loading: false };
        ...
        case ADD_USER_MEASUREMENTS_UPPERBODY_SUCCESS:
            return { ...state, standard_measurements_upperbody: [...state.standard_measurements_upperbody, action.payload], loading: false, error: false, message: action.payload.message };
        ...
        case EDIT_DELETE_USER_MEASUREMENTS_UPPERBODY_SUCCESS:
            return {
                ...state,
                standard_measurements_upperbody: state.standard_measurements_upperbody.map((standard_measurements_upperbody) =>
                standard_measurements_upperbody.id === action.payload.id ? action.payload : standard_measurements_upperbody
                ),
...
export default standard_measurements_upperbody_reducer;